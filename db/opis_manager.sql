...
CREATE TABLE `insegnamento` (
  ...
  `semestre` varchar(4) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cfu` varchar(4) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `assegn` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
